...
if [[ -n "${6:-}" ]]; then
    echo "Running SMR.."
    smr --bfile $plink_path --gwas-summary $6 --beqtl-summary $dir/tempeqtl_$h5ad_pref --out $dir/${h5ad_pref} --thread-num $num_cpus >> $dir/osca_intermediate/smr_progress.log 2>&1
fi